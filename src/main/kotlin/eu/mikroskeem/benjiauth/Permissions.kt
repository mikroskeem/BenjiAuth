...
const val ACTION_RELOAD = "benjiauth.admin.reload"
const val ACTION_FORCELOGIN = "benjiauth.admin.forcelogin"
const val ACTION_UNREGISTER = "benjiauth.admin.unregister"